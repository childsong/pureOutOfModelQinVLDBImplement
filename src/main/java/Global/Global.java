...
public interface Global {
    ...
    /** 剪枝率,而剪枝频率下限，一个是针对batch的一个是针对single的,注意这个剪枝频率剪枝的是大于这个频率的*/
    float pruneRate=0.00001f;
    Double freqThresholdForSingle=100.0;
    Double freqThresholdForBatch=100.0;
    ...
    int singleSamplePrunedSize=100000;
    int batchSamplePrunedSize=5000;
