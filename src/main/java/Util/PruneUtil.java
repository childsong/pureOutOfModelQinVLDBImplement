...
public class PruneUtil {
    public static List<Integer> prune(SampleList sampleList, float pruneRate, double threshold, int samplePrunedSize){
        /**
        ...
        */
        ...
        for(int i=0;i<samplePrunedSize;i++){
            for(int j=0;j<sampleList.sampleList.get(i*(sampleList.sampleListSize/samplePrunedSize)).cat.length;j++){
